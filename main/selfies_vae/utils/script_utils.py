...
def add_train_args(parser):
    ...
    common_arg.add_argument('--train_smiles', type=str, default=None,
                        help='Path to the training SMILES file')
    common_arg.add_argument('--val_smiles', type=str, default=None,
                        help='Path to the validation SMILES file')
